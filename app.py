...
def analyze_plan_with_claude(image_path):
    ...
    prompt = "You are an expert HVAC engineer analyzing a mechanical floor plan. Look at this plan carefully and extract the following in JSON format: 1) building_outline as polygon points normalized 0-1000, 2) rooms with name and bbox [x,y,w,h] normalized 0-1000, 3) vavs with tag and pos [x,y] normalized 0-1000, 4) ahus with tag and pos, 5) ducts as paths, 6) diffusers as points. Return ONLY valid JSON. Example: {\"building_outline\":[[100,100],[900,100],[900,900],[100,900]],\"rooms\":[{\"name\":\"Office 101\",\"bbox\":[120,120,200,150]}],\"vavs\":[{\"tag\":\"VAV-1\",\"pos\":[200,180]}],\"ahus\":[{\"tag\":\"AHU-1\",\"pos\":[500,500]}],\"ducts\":[{\"path\":[[500,500],[400,500],[200,200]]}],\"diffusers\":[{\"pos\":[200,200]}]}"
...
Made by Paolo V. and Emmanuel R.
