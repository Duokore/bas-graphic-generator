...
PNG_OUTPUT_PATH = os.path.join(
    OUTPUT_FOLDER,
    "bas_graphic_transparent.png"
)

ISOMETRIC_OUTPUT_PATH = os.path.join(
    OUTPUT_FOLDER,
    "bas_graphic_isometric.png"
)
...
def home():
    ...
    ">
        ...
        ">
            ...
            <h1>
                BAS Graphic Generator v3
            </h1>

            <p style="color:#b8bcc8;">
                AI Room Detection · Pseudo 3D · Isometric Engine
            </p>
...
def generate():
    ...
    generated_base64 = image_to_base64(
        PNG_OUTPUT_PATH
    )

    iso_base64 = image_to_base64(
        ISOMETRIC_OUTPUT_PATH
    )
    ...
    <body>
        ...
        <p style="
            ...
            color:#b8bcc8;
        ">
            AI Detection · Room Segmentation · Isometric Engine v1
        </p>
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="viewer">
                    ...
                    <img
                        src="data:image/png;base64,{iso_base64}"
                    >
